...
Diese Verlagerung kann sowohl auf zeitlicher Ebene als auch auf örtlicher Ebene (Location Shifting) stattfinden~\cite{GreenSoftwareFoundation.2022}.
...
\section{Einführung in die Zeitreihenprognose}
...
Die \ac{MOER}-Werte werden über die \ac{API} von WattTime pro Monat für die Länder Deutschland und Schweden abgefragt.
...
Dafür werden sie, wie in Kapitel xy beschrieben, in Trend, Saisonalität und Residual zerlegt.
...
Der zuvor beschriebene Datensatz wird aufgeteilt in einen Trainingsdatensatz, einen Validierungsdatensatz und einen Testdatensatz, wie in Abbildung~\ref{FIG:moer_de_train_validation_test} sichtbar wird.
...
\begin{figure}
 \caption{Die Unterteilung der MOER-Werte für Deutschland in Trainings-, Validierungs- und Testdatensatz}
 {\includegraphics[width=0.99\textwidth]{\figdir/moer_de_train_validation_test}}
 \label{FIG:moer_de_train_validation_test}
\end{figure}
