...
Nach der Einleitung werden in Kapitel 2 die theoretischen Grundlagen nachhaltiger Softwarearchitektur und die Relevanz der Kohlenstoffintensität als Maßstab für Nachhaltigkeit dargelegt.

Kapitel 3 widmet sich verschiedenen Strategien zur Optimierung der Nachhaltigkeit von Softwaresystemen.
...
Kapitel 4 bietet eine Einführung in die Grundlagen der Zeitreihenprognose, gefolgt von detaillierten Beschreibungen des SARIMAX-Modells sowie des Temporal Fusion Transformers als fortschrittliches KI-basiertes Modell.
Es dient als Grundstein für das darauffolgende Kapitel.

Kapitel 5 fokussiert sich auf die Prognose der Kohlenstoffintensität.
...
Anwendungsmöglichkeiten der in Kapitel 5 entwickelten Prognosemodelle werden in Kapitel 6 aufgezeigt.
...
Die Ergebnisse der Anwendung der Modelle sowie eine umfassende Diskussion werden ebenfalls in diesem Kapitel präsentiert.

Das abschließende Kapitel 7 bietet ein Resümee der gesamten Arbeit und einen Ausblick auf zukünftige Forschungsmöglichkeiten in diesem Bereich.
...
%!
%!
\chapter{Grundlagen nachhaltiger Software}
...
\begin{table}[t]
 \centering\small
 \caption{Die drei verschiedenen Dimensionen von Emissionen laut dem GHG Protokoll~\cite{WorldBusinessCouncilforSustainableDevelopment.2004}}
 \label{tab:GhgScopes}
...
\begin{table}[t]
 \caption{Die Datenquellen, die WattTime für die Modellierung der MOER verwendet (\cite{WattTime.20231121T18:47:09+00:00})}
...
\begin{figure}
 \caption[Monatlicher Verlauf der MOER von Deutschland und Norwegen]{Die Höhe der MOER des deutschen und norwegischen Stromnetzes pro Monat (eigene Darstellung)}
...
\begin{figure}
 \caption{TFT Vorhersage der deutschen Werte für eine Woche (eigene Darstellung)}
 {\includegraphics[width=0.99\textwidth]{\figdir/tft_de-no_168_de-plot}}
...
\begin{figure}
 \caption{TFT Wichtigkeit der einzelnen Variablen für den Dencoder (eigene Darstellung)}
...
\textit{\ac{AWS} Lambda Scheduled Events} ermöglichen die automatische Ausführung von Funktionen zu gewünschten Zeitpunkten und in regelmäßigen Abständen.
...
Amazon setzt dafür standardmäßig \textit{Amazon CloudWatch} ein, ein Tool zur Beobachtung bestimmter Metriken einer Instanz, mit Metriken wie z.B. der CPU-Auslastung zur Überwachung der Last und entsprechender Ressourcenanpassung verwendet.
...
Die Implementierung von Google, der \textit{Google Cloud Autoscaler}, bietet ähnliche Funktionalitäten und passt die Anzahl der Instanzen Virtueller Maschinen automatisch an die Anforderungen der Workloads an, um die Leistung zu optimieren und die Kosten zu minimieren.
...
\begin{itemize}
 ...
 Es hat sich gezeigt, dass sich \ac{SARIMAX}-Modelle nicht für den betrachteten Anwendungsfall eignen.
 Sie können die Schwankungen der Werte nicht genau genug abbilden.
 ...
 Als wichte Eingabedaten haben sich ... herausgestellt.
 ... waren unwichtig für die Vorhersage.
