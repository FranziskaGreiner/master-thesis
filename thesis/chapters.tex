...
In dieser Abbildung wird sichtbar, dass die höchste \ac{MOER} nicht unbedingt zum gleichen Zeitpunkt wie ein Nachfragehoch auftritt~\cite{DiStefano.2019}.
...
Die Abbildung~\ref{FIG:weather-data-by-month}b des durchschnittlichen Niederschlags pro Monat zeigt, dass sich das der Verlauf und die Höhe der Werte pro Land unterscheiden.
...
Das Package \textit{statsmodels} bietet eine einfache Möglichkeit, die Diagnostik für die Residuen, also die Differenzen zwischen beobachteten und vom Modell vorhergesagten Werten, einzusehen.
...
Die Wichtigkeit der letzen Rund 25 Zeitschritte scheint mit Blick auf den Verlauf der \ac{MOER} in Deutschland um den Vorhersagezeitpunkt logisch, denn zu diesem Zeitpunkts ist ein starker Abfall der Werte zu verzeichnen.
...
Den nächst großen Einfluss haben die binäre Variable zur Feiertags-/Wochenendinformation, der \ac{MOER}-Wert vor 168 Stunden und die Windgeschwindigkeit.
...
Hier übersteigt die \ac{MOER} Deutschlands diejenige Norwegens, was zu negativen Einsparungen, das heißt zu einer Erhöhung der CO2-Emissionen, führen würde.
...
\noindent In diesem Kapitel sollen Herausforderungen und Grenzen diskutiert werden und mögliche Erweiterungen und Anknüpfungen zur vorliegednen Arbeit identifiziert werden.
...
Im betrachteten Zeitraum (2021-2024) waren das unter anderem die COVID-19-Pandemie, geopolitische Konflikte wie der Russland-Krieg und infrastrukturelle Angriffe wie ein Anschlag auf die Nordstream Gas-Pipelines~\cite{Baumgartner.30.9.2022}.
...
Die verschiedenen Messungen kommen höchstwahrscheinlich daher, dass bei Wiesner et al.~\cite{Wiesner.2021} die durchschnittliche Kohlenstoffintensität des Stromnetzes verwendet wurde, die sich nach aktuellem Wissensstand wie bereits beschrieben nur schlecht für die Analyse von Laständerungen eignet.
...
Anders herum führt beispielsweise eine Reduzierung der Cloud-Kosten meist dadurch zu geringeren Emissionen, als dass es darauf abzielt, weniger Ressourcen zu nutzen oder die verwendeten Ressourcen besser auszunutzen~\cite{Thoughtworks.2020}.
...
\begin{enumerate}
 ...
 Zur Prognose der \ac{MOER} der Stromnetze in Deutschland und Norwegen wurden verschiedene Vorhersageodelle entwickelt.
 ...
 Die Prognoseergebnisse auf gefilterten Daten waren besser, allerdings zum Nachteil des Verlusts von wichtigen Ausreißern, die für Lastverschiebung genutzt werden könnten.
 Als relevante Eingabedaten haben sich vor allem die Stunde, der Zeitindex, der Wind und die zeitverzögerte \ac{MOER} erwiesen, während der Niederschlag und ob ein Feiertag oder Wochenendtag vorliegt von geringer Bedeutung für die Vorhersage waren.
 ...
 Die deutschen Werte sind im Durchschnitt fast dreimal so hoch wie die norwegischen, sie bieten jedoch den Vorteil, dass sie unter anderem aufgrund der Zusammensetzung der Energiequellen besser vorhersagbar sind.
 ...
 Durch die Entwicklung und den Vergleich effektiver Prognosemodelle und die Untersuchung von Lastverlagerungsstrategien werden praktische Erkenntnisse und Empfehlungen bereitgestellt, die eine nachhaltigere Softwarearchitektur und Anwendungsbetrieb ermöglichen.
 ...
 Kalkulationsmodelle und beispielhafte Analysen veranschaulichen die Berechnung der Kohlenstoffintensität und des Einsparpotenzial.
