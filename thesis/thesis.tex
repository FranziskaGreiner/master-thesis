  \documentclass[twoside=false, %  doppelseitiger Druck
    ...
    fontsize=13pt,%             use this font size
    paper=a4,%          use ISO A4
...
\usepackage{lmodern}
\definecolor{chaptercolor}{RGB}{55, 65, 105}
\addtokomafont{disposition}{\color{chaptercolor}}
\addtokomafont{chapter}{\huge}
\RedeclareSectionCommand[
  beforeskip=0pt, % Space before the chapter title
  afterskip=15pt, % Space after the chapter title
  innerskip=0pt, % Space between chapter prefix and title
]{chapter}
\renewcommand*{\chapterformat}{% Redefine the chapter number format
  \fontsize{50}{60}\selectfont\thechapter\autodot\enskip
}
